  ...
  return (
    <>
      <section className="courses-category-area ptb-50">
        ...
        {params.param == 1  ? (
          <>
            <Apply title="To get all books code at once just pay" price={data.price} slug="book-bundle-1" ></Apply>
            <br />
          </>
        ) : params.param == 2 ? (
          <>
            <Apply title="To get all books code at once just pay" price={data.price} slug="book-bundle-2" ></Apply>
            <br />
          </>
        ) : (
          <>
