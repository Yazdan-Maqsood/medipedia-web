...
export default function Saved(props) {
    ...
    const [actualduration, setactualDuration] = useState({ hours: props.hoursminsec.hour, minutes: 0, seconds: 0 });
 ...
 console.log(props);
    ...
    const [duration, setDuration] = useState({ hours: props.durations.hour, minutes: props.durations.mint, seconds: props.durations.sec });
